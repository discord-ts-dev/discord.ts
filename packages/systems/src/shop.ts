...
export async function buy(store: Store, userId: string, item: ShopItem, qty = 1): Promise<BuyResult> {
...
export async function useItem(store: Store, userId: string, itemId: string, qty = 1): Promise<boolean> {
